...
def Follow_Line(testMode = False, intersectionQueue = [], robot = loadRobot('ROBOSON.json')):
    ...
    basespeedBooster = robot.speed.booster
    ...
    for frame in camera.capture_continuous(rawCapture, format = "bgr", use_video_port = True):
        ...
        doublePreviousDeltaX = previousDeltaX 
        ...
        # Finding the derivative
        curvature = (currentDeltaX - 2 * previousDeltaX + doublePreviousDeltaX) / (derivativeDeltaTime) ** 2        
